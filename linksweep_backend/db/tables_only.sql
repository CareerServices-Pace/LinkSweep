-- LinkSweep Database Tables Only
-- Use this file if you already have a database and just need to create tables
-- Run: psql -U postgres -d your_database_name -f tables_only.sql
